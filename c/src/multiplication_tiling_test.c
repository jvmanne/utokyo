...
void multiplication_tiling_test(void) {
    printf("**************************************\n");
    ...
    for (int current_block_size=block_start; current_block_size<=block_end; current_block_size+=block_increase) {
        for (int i=0; i<number_of_tests; i++) {
            ...
            // printf("Loop tiling 1-1 with block size %d - Time is %f milliseconds\n", current_block_size, current_time);
        }
    }
    printf("Loop tiling 1-1 - Optimal block size %d - Shortest time is %f milliseconds\n", optimal_block_size_1, shortest_time_1);
    ...
    for (int current_block_size=block_start; current_block_size<=block_end; current_block_size+=block_increase) {
        for (int i=0; i<number_of_tests; i++) {
            ...
            // printf("Loop tiling 1-3 with block size %d - Time is %f milliseconds\n", current_block_size, current_time);
        }
    }
    printf("Loop tiling 1-3 - Optimal block size %d - Shortest time is %f milliseconds\n", optimal_block_size_3, shortest_time_3);
    ...
    for (int current_block_size=block_start; current_block_size<=block_end; current_block_size+=block_increase) {
        for (int i=0; i<number_of_tests; i++) {
            ...
            // printf("Loop tiling 1-4 with block size %d - Time is %f milliseconds\n", current_block_size, current_time);
        }
    }
    printf("Loop tiling 1-4 - Optimal block size %d - Shortest time is %f milliseconds\n", optimal_block_size_4, shortest_time_4);
    ...
    for (int current_block_size=block_start; current_block_size<=block_end; current_block_size+=block_increase) {
        for (int i=0; i<number_of_tests; i++) {
            ...
            // printf("Loop tiling 1-5 with block size %d - Time is %f milliseconds\n", current_block_size, current_time);
        }
    }
    printf("Loop tiling 1-5 - Optimal block size %d - Shortest time is %f milliseconds\n", optimal_block_size_5, shortest_time_5);
    ...
    for (int current_block_size=block_start; current_block_size<=block_end; current_block_size+=block_increase) {
        for (int i=0; i<number_of_tests; i++) {
            ...
            // printf("Loop tiling 1-6 with block size %d - Time is %f milliseconds\n", current_block_size, current_time);
        }
    }
    printf("Loop tiling 1-6 - Optimal block size %d - Shortest time is %f milliseconds\n", optimal_block_size_6, shortest_time_6);
